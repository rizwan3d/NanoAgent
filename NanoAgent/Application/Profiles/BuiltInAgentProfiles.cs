...
internal static class BuiltInAgentProfiles
{
    ...
    public static IAgentProfile Build { get; } = new BuiltInAgentProfile(
        ...
        Lesson memory is off by default and can be enabled per workspace with /lessons on. When enabled, relevant lessons from .nanoagent/memory/lessons.jsonl are injected automatically into prompts, and automatic tool-failure observation can create or refine lessons about repeated mistakes and fixes.
