...
namespace StemCode.Infrastructure;

internal sealed class ProviderRequestProjectHeaderProvider
{
    internal const string DefaultRequestTitle = "StemCode";
    internal const string ProjectNameEnvironmentVariableName = "STEMCODE_PROJECT_NAME";
    internal const string TitleEnvironmentVariableName = "STEMCODE_TITLE";
