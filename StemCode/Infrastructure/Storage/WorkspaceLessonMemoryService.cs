...
internal sealed partial class WorkspaceLessonMemoryService : ILessonMemoryService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        builder.AppendLine("Persistent workspace lessons from .stemcode/memory/lessons.jsonl. Use them as starting hypotheses, then verify against current files and fresh tool output.");
