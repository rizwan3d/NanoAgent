    ...
    string Text)
{
        ...
        bool commandLineTooLong = false)
    {
        ...
        string setupState = DescribeSetupState(context.StemCodeHome);
        ...
        builder.AppendLine("setup_marker=" + WindowsSandboxPaths.SetupMarkerPath(context.StemCodeHome));
        builder.AppendLine("sandbox_users=" + WindowsSandboxPaths.SandboxUsersPath(context.StemCodeHome));
        builder.AppendLine("helper_binary_path=" + WindowsSandboxPaths.SandboxBinDir(context.StemCodeHome));
    ...
    public void Log(string stemCodeHome)
    {
    ...
    private static string DescribeSetupState(string stemCodeHome)
    {
        string markerPath = WindowsSandboxPaths.SetupMarkerPath(stemCodeHome);
        string usersPath = WindowsSandboxPaths.SandboxUsersPath(stemCodeHome);
