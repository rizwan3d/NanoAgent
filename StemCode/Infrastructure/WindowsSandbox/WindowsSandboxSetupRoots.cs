...
internal static class WindowsSandboxSetupRoots
{
   ...
   internal static List<string> GatherReadRoots(
        ...
        string stemCodeHome)
    {
        ...
        roots.Add(WindowsSandboxPaths.SandboxBinDir(stemCodeHome));
    ...
    internal static List<string> FilterSensitiveWriteRoots(List<string> roots, string stemCodeHome)
    {
        string homeKey = CanonicalPathKey(stemCodeHome);
        string sandboxDir = WindowsSandboxPaths.SandboxDir(stemCodeHome);
        string sandboxBinDir = WindowsSandboxPaths.SandboxBinDir(stemCodeHome);
