...
{
    public static WindowsCapabilitySids LoadOrCreate(string stemCodeHome)
    {
        string path = WindowsSandboxPaths.CapSidFile(stemCodeHome);
        if (File.Exists(path))
        {
    ...
    public static string WorkspaceSidForCwd(string stemCodeHome, string cwd)
    {
        string path = WindowsSandboxPaths.CapSidFile(stemCodeHome);
        WindowsCapabilitySids sids = LoadOrCreate(stemCodeHome);
