...
internal static class WindowsSandboxUserProvisioner
{
    ...
    public static WindowsSandboxUsersFile EnsureUsers(string stemCodeHome)
    {
    ...
    private static WindowsSandboxUserRecord EnsureUser(string username)
    {
        ...
        UserInfo1 user = new()
        {
            ...
            usri1_home_dir = null,
            usri1_comment = "StemCode Windows sandbox account",
    ...
    private static void EnsureLocalGroup(string groupName)
    {
        LocalGroupInfo1 group = new()
        {
            ...
            lgrpi1_comment = "StemCode Windows sandbox users"
        };
