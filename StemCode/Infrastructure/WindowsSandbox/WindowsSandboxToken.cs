...
internal sealed class WindowsSandboxToken : IDisposable
{
    ...
    public static WindowsSandboxToken CreateRestricted(string stemCodeHome, IEnumerable<string> restrictingSidStrings)
    {
        ...
        WindowsSandboxCredentials credentials = WindowsSandboxIdentity.LoadOfflineCredentials(stemCodeHome);
