...
namespace StemCode.Infrastructure.CodeIntelligence;
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (servers.Length == 0)
        {
            throw new CodeIntelligenceUnavailableException(
                ...
                ["Add a language server entry under .stemcode/agent-profile.json -> languageServers to support this extension."]);
        }
