...
namespace StemCode.Infrastructure.BudgetControls;
...
internal sealed class BudgetControlsUsageService : IBudgetControlsUsageService
{
    ...
    /// <c>.stemcode/budget-controls.*.json</c> file exists.
    /// </summary>
    ...
    /// the default <c>.stemcode</c> directory, preferring the default local file, or
