...
{
    public const string DirectoryPath = ".stemcode/memory";
    ...
    public static string CreateTemplate(RepoMemoryDocumentDefinition document)
    {
        ...
        return
            ...
            Keep this file focused on durable, team-reviewed memory. StemCode treats it as repo-scoped context that your team can inspect, diff, and version-control.
            """;
    }
