...
internal sealed class RepoMemoryTool : ITool
{
    ...
    public string Description => "List, read, or write structured repo-scoped team memory markdown files under .stemcode/memory. These files are ordinary project files that teams can inspect, diff, and version-control. Writes require memory approval.";
