    ...
    public string Schema => """
        {
          ...
          "properties": {
            ...
            "includeIgnored": {
              "type": "boolean",
              "description": "When true, also include files ignored by the project's .gitignore. The agent's .stemcode/.stemcodeignore is always respected, even when this is true."
            },
            "limit": {
              "type": "integer",
              "minimum": 1,
