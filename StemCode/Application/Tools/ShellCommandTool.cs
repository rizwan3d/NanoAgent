...
internal sealed class ShellCommandTool : ITool
{
    ...
    private const string UnsupportedSandboxNote = "OS-level shell sandboxing is not available on this platform; the command ran after StemCode permission approval without OS-level sandbox enforcement.";
