...
internal sealed class LessonMemoryTool : ITool
{
    ...
    public string Description => "Save, search, list, edit, or delete persistent workspace lessons about mistakes, failures, and fixes. Lessons are stored in .stemcode/memory/lessons.jsonl and are also retrieved automatically for relevant future prompts.";
