...
internal sealed class SettingCommandHandler : IReplCommandHandler
{
    ...
    public string Description => "Open the StemCode settings picker for configurable session and workspace options.";
            ...
            new SelectionPromptRequest<SettingCommandArea>(
                ...
                [
                    ...
                    new SelectionPromptOption<SettingCommandArea>(
                        ...
                        "Create or review workspace-local StemCode files."),
                    new SelectionPromptOption<SettingCommandArea>(
                        "Permissions",
                    ...
                    new SelectionPromptRequest<SettingPermissionAction>(
                        ...
                        [
                            ...
                            new SelectionPromptOption<SettingPermissionAction>(
                                ...
                                "Return to StemCode settings.")
                        ],
                        "Default and sandbox changes are saved to .stemcode/agent-profile.json. Rule changes here are session-scoped. Esc returns to StemCode settings.",
                        DefaultIndex: 0,
                        AllowCancellation: true),
                    cancellationToken);
            }
    ...
    private static string FormatHelp()
    {
        return "Settings commands:\n" +
            ...
            "/setting workspace [recommended|minimal|custom] - Choose and initialize workspace-local StemCode files.\n" +
