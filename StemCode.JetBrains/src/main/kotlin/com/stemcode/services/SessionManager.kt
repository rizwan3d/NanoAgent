 ...
 */
class SessionManager(private val processManager: StemCodeProcessManager) {
    ...
    fun sendPrompt(text: String): CompletableFuture<String?> {
        val client = acpClient ?: return CompletableFuture.failedFuture(
            IllegalStateException("StemCode ACP client is not initialized.")
        )
    ...
    private fun terminateSession() {
        ...
        val error = RuntimeException("StemCode process stopped.")
    ...
    private fun handlePermissionRequest(
        ...
        val id = "perm-${System.stemcodeTime()}"
    ...
    private fun handleTextRequest(
        ...
        val id = "text-${System.stemcodeTime()}"
