...
namespace StemCode.Tests.Infrastructure.Hooks;
...
public sealed class ShellLifecycleHookServiceTests
{
    ...
    public async Task RunAsync_Should_InvokeMatchingHookWithPayloadAndEnvironment()
    {
        ...
        request.EnvironmentVariables.Should().ContainKey("STEMCODE_HOOK_EVENT")
            .WhoseValue.Should().Be("before_tool_call");
        request.EnvironmentVariables.Should().ContainKey("STEMCODE_TOOL_NAME")
