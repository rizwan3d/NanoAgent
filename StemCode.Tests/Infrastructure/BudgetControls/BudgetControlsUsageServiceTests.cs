...
namespace StemCode.Tests.Infrastructure.BudgetControls;
...
public sealed class BudgetControlsUsageServiceTests
{
    ...
    public async Task RecordUsageAsync_Should_DenySymlinkFileBreakout()
    {
        ...
        string budgetDirectory = Path.Combine(workspacePath, ".stemcode");
        ...
        try
        {
            ...
            {
                Settings = BudgetControlsSettings.Local(".stemcode/budget.json")
            };
    ...
    public async Task RecordUsageAsync_Should_UpdateLocalUsageAndCost()
    {
        ...
        await sut.ConfigureLocalAsync(
            session,
            ".stemcode/budget-controls.local.json",
        ...
        string budgetPath = Path.Combine(workspacePath, ".stemcode", "budget-controls.local.json");
