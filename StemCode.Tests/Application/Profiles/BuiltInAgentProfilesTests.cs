...
namespace StemCode.Tests.Application.Profiles;
...
public sealed class BuiltInAgentProfilesTests
{
    ...
    public void Build_Profile_Should_Have_BuildName()
    {
        ...
        BuiltInAgentProfiles.Build.Mode.Should().Be(StemCode.Application.Models.AgentProfileMode.Primary);
    }
    ...
    public void Plan_Profile_Should_Have_PlanName()
    {
        ...
        BuiltInAgentProfiles.Plan.Mode.Should().Be(StemCode.Application.Models.AgentProfileMode.Primary);
    }
    ...
    public void Review_Profile_Should_Have_ReviewName()
    {
        ...
        BuiltInAgentProfiles.Review.Mode.Should().Be(StemCode.Application.Models.AgentProfileMode.Primary);
    }
    ...
    public void General_Profile_Should_Have_GeneralName()
    {
        ...
        BuiltInAgentProfiles.General.Mode.Should().Be(StemCode.Application.Models.AgentProfileMode.Subagent);
    }
    ...
    public void Explore_Profile_Should_Have_ExploreName()
    {
        ...
        BuiltInAgentProfiles.Explore.Mode.Should().Be(StemCode.Application.Models.AgentProfileMode.Subagent);
    }
