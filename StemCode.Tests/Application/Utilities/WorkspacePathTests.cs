...
namespace StemCode.Tests.Application.Utilities;
...
public sealed class WorkspacePathTests
{
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-workspace-root"));
    ...
    {
        string parent = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-parent"));
        string sibling = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-parent-2"));
    ...
    {
        string left = Path.Combine(Path.GetTempPath(), "stemcode", ".", "src", "..", "src");
        string right = Path.Combine(Path.GetTempPath(), "stemcode", "src");
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-resolve-root"));
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-resolve"));
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-safe-root"));
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-relative-root"));
    ...
    {
        string root = Path.GetFullPath(Path.Combine(Path.GetTempPath(), "stemcode-relative"));
