...
```bash
# Restore
dotnet restore StemCode.slnx

# Build
dotnet build StemCode.slnx --configuration Release

# Run all tests
dotnet test StemCode.Tests/StemCode.Tests.csproj --configuration Release
