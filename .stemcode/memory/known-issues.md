...
**Status**: By design â€” Inno Setup provides a proper Windows installer experience.
...
**Area**: `StemCode.JetBrains/build.gradle.kts`  
...
*(None documented yet â€” this section can be populated as fixes are applied.)*
